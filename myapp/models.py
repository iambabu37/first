...
class McProp(models.Model):
    ...
    impaat = models.CharField(max_length =255,blank = True,null = True)
    chembl = models.CharField(max_length = 255,blank = True,null = True )
    pubchem = models.CharField(max_length = 255,blank = True,null = True )
    zinc = models.CharField(max_length = 255,blank = True,null = True )
    surecheml = models.CharField(max_length = 255,blank = True,null = True )
    Molprot = models.CharField(max_length = 255,blank = True,null = True )
