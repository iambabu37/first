...
class Phytochemical(models.Model):
    ...
    molecular_weight = models.CharField(max_length=255,null = True,blank=True)
    kegg_id = models.CharField(max_length=255,null = True,blank=True)
    chembl_id = models.TextField(null = True,blank=True)
